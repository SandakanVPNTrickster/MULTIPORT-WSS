...
wget -q -O /usr/bin/sshws-true "https://raw.githubusercontent.com/SandakanVPNTrickster/MULTIPORT-WSS/main/sshws-true.sh" && chmod +x /usr/bin/sshws-true
wget -q -O /usr/bin/update "https://raw.githubusercontent.com/SandakanVPNTrickster/MULTIPORT-WSS/main/update.sh" && chmod +x /usr/bin/update
